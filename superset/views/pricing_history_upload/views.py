...
class PcuView(SimpleFormView):
    form = PhuForm
    route_base = "/phu"
    form_template = "superset/form_view/pricing_history_upload_view/edit.html"
    form_title = _("Pricing History Upload Form")

    def form_get(self, form: PhuForm) -> None:
        pass

    def form_post(self, form: PhuForm) -> Response:
        pass
